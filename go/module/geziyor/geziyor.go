...
import (
	...
	"hentai_parser/go/module/geziyor/metrics"
	"hentai_parser/go/module/geziyor/middleware"
	"io/ioutil"
	"log"
	"net/http/cookiejar"
	"os"
...
func defaultChromeDir() string {
	return "/home/modeck/.config/google-chrome/Default/"
}
...
func NewGeziyor(opt *Options) *Geziyor {
	...
	if opt.ChromeDir != "" {
		opt.ChromeDir = defaultChromeDir()
	}
	geziyor := &Geziyor{
		Opt:     opt,
